...
const authMiddlewareVendor = require("../middlewares/auth-middleware-vendor");
...
router.route("/vendor-details").get(authMiddlewareVendor, authcontroller.vendorDetails);
